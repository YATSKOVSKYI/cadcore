...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let solid_id = sweep_circle_along_polyline(&mut brep, &waypoints, filament_radius, &opts)?;

    let stats = brep.stats();
    println!("B-Rep stats: {} faces, {} shells, {} solids", stats.faces, stats.shells, stats.solids);
